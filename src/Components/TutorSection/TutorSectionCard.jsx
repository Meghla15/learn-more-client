...
const TutorSectionCard = ({studySession}) => {
	...
	<img src={tutorImg} alt="" className="w-36 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		<div className="my-2 space-y-1">
			<h2 className="text-xl font-semibold sm:text-2xl">{tutorName}</h2>
			<p className="px-5 text-xs sm:text-base dark:text-gray-600">{tutorDegree}</p>
		</div>
